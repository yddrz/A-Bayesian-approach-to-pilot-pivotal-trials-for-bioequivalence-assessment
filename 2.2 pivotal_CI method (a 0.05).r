...
result1_3<-cimethod(aucallp3,10000)
sum(result1_1)
sum(result1_2)
sum(result1_3)
...
result2_3<-cimethod(aucallp4,10000)
sum(result2_1)
sum(result2_2)
sum(result2_3)
...
result3_3<-cimethod(aucallp5,10000)
sum(result3_1)
sum(result3_2)
sum(result3_3)
...
result4_3<-cimethod(aucallp6,10000)
sum(result4_1)
sum(result4_2)
sum(result4_3)
...
result5_3<-cimethod(aucallp7,10000)
sum(result5_1)
sum(result5_2)
sum(result5_3)
